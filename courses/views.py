...
class CourseModuleUpdateView(TemplateResponseMixin, View):
    ...
    # Takes an HTTP request and its parameters and attempts
    # to delegate to a lowercase method that matches the HTTP method used.
...
class ContentCreateUpdateView(TemplateResponseMixin, View):
    ...
    # The model form, passing any submitted data and files to it.
